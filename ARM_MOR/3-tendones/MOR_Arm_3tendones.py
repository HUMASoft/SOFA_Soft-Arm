...
tendon1 = ObjToAnimate("eobject/tendon1", incr=2,incrPeriod=10,rangeOfAction=40)
tendon2 = ObjToAnimate("eobject/tendon2", incr=2,incrPeriod=10,rangeOfAction=40)
tendon3 = ObjToAnimate("eobject/tendon3", incr=2,incrPeriod=10,rangeOfAction=40)
...
listObjToAnimate = [tendon1,tendon2,tendon3]
