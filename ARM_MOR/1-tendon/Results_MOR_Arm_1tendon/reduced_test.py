...
class ArmController(Sofa.PythonScriptController):
    def __init__(self, node, tendon):
        self.cableconstraintvalue = tendon.getObject("CableConstraint").findData('value')
...
def Reduced_test( parentNode=None,
                  attachedTo=None,
                  name="Reduced_test",
